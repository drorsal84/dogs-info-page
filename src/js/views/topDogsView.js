        ...
        <div class="card top-dogs__card--1">
            ...
            <div class="card-body">
                ...
                <div class="card-footer top-dogs__card--footer">
                    <h4><a href="https://en.wikipedia.org/wiki/Malinois_dog" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                </div>
            </div>
        </div>
    </div>
    <div class="col-6 col-lg-2">
        <div class="card top-dogs__card--2">
            ...
            <div class="card-body">
                ...
                <h4 class="card-text top-dogs__card--text">The doberman breed was developed for two purposes: protection and companionship. They are extremely loyal to their owners, and are ofter integrated in police units around the world.</h4>
                <div class="card-footer top-dogs__card--footer">
                    <h4><a href="https://en.wikipedia.org/wiki/Dobermann" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                </div>
            </div>
        </div>
    </div>
    <div class="col-6 col-lg-2">
        <div class="card top-dogs__card--3">
            ...
            <div class="card-body">
                ...
                <div class="card-footer top-dogs__card--footer">
                    <h4><a href="https://en.wikipedia.org/wiki/Cane_Corso" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                </div>
            </div>
        </div>
    </div>
    <div class="col-6 col-lg-2">
        <div class="card top-dogs__card--4">
            ...
            <div class="card-body">
                ...
                <div class="card-footer top-dogs__card--footer">
                    <h4><a href="https://en.wikipedia.org/wiki/Neapolitan_Mastiff" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                </div>
            </div>
        </div>
    </div>
    <div class="col-6 col-lg-2">
        <div class="card top-dogs__card--5">
            ...
            <div class="card-body">
                ...
                <div class="card-footer top-dogs__card--footer">
                    <h4><a href="https://en.wikipedia.org/wiki/German_Shepherd" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-6 col-lg-2">
                    <div class="card top-dogs__card--1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer top-dogs__card--footer">
                                <h4><a href="https://en.wikipedia.org/wiki/Labrador_Retriever" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-2">
                    <div class="card top-dogs__card--2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer top-dogs__card--footer">
                                <h4><a href="https://en.wikipedia.org/wiki/Bulldog" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-2">
                    <div class="card top-dogs__card--3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer top-dogs__card--footer">
                                <h4><a href="https://en.wikipedia.org/wiki/Golden_Retriever" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-2">
                    <div class="card top-dogs__card--4">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-text top-dogs__card--text">Beagles are incredibly energetic and could be the perfect fit for families with small children. After spending their daily energy, their high intelligence makes them adaptable and very easy to train.</h4>
                            <div class="card-footer top-dogs__card--footer">
                                <h4><a href="https://en.wikipedia.org/wiki/Beagle" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-2">
                    <div class="card top-dogs__card--5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer top-dogs__card--footer">
                                <h4><a href="https://en.wikipedia.org/wiki/Irish_Setter" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-6 col-lg-2">
                    <div class="card top-dogs__card--1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer top-dogs__card--footer">
                                <h4><a href="https://en.wikipedia.org/wiki/Alaskan_Malamute" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-2">
                    <div class="card top-dogs__card--2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer top-dogs__card--footer">
                                <h4><a href="https://en.wikipedia.org/wiki/Bernese_Mountain_Dog" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-2">
                    <div class="card top-dogs__card--3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer top-dogs__card--footer">
                                <h4><a href="https://en.wikipedia.org/wiki/Boxer_(dog)" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-2">
                    <div class="card top-dogs__card--4">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-text top-dogs__card--text">The Dogo Argentino is a pack-hunting dog, bred for the pursuit of big-game such as wild boar and puma, and possesses the strength, smarts and quick responsiveness of a serious athlete.</h4>
                            <div class="card-footer top-dogs__card--footer">
                                <h4><a href="https://en.wikipedia.org/wiki/Dogo_Argentino" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-lg-2">
                    <div class="card top-dogs__card--5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer top-dogs__card--footer">
                                <h4><a href="https://en.wikipedia.org/wiki/St._Bernard_(dog)" target="_blank">For more info &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;click here</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
